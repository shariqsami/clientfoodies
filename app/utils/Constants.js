...
export const BASE_URL = "http://fooddelivery.thinksolutionz.org/v1/api/";
//export const REGISTRATION_URL = BASE_URL + "registration";
export const REGISTRATION_URL = BASE_URL + "notapproved";
export const LOGIN_URL = BASE_URL + "login";
export const LOGOUT_URL = BASE_URL + "logout";
export const CHECK_WALLET = BASE_URL + "getwallet";
